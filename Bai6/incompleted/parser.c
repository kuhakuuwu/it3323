...
void compileBlock(void)
{
  ...
  if (lookAhead->tokenType == KW_CONST)
  {
    ...
    {
      eat(TK_IDENT);
      // Kiểm tra định danh hằng số chưa được khai báo
...
void compileBlock2(void)
{
  ...
  if (lookAhead->tokenType == KW_TYPE)
  {
    ...
    {
      eat(TK_IDENT);
      // Kiểm tra định danh kiểu chưa được khai báo
      checkFreshIdent(currentToken->string);
...
void compileBlock3(void)
{
  ...
  if (lookAhead->tokenType == KW_VAR)
  {
    ...
    {
      eat(TK_IDENT);
      // Kiểm tra định danh biến chưa được khai báo
      checkFreshIdent(currentToken->string);
...
void compileFuncDecl(void)
{
  ...
  eat(KW_FUNCTION);
  eat(TK_IDENT);
  // Kiểm tra định danh hàm chưa được khai báo
  checkFreshIdent(currentToken->string);
...
ConstantValue *compileUnsignedConstant(void)
{
  ...
  case TK_IDENT:
    eat(TK_IDENT);
    // Kiểm tra hằng số được khai báo và lấy giá trị của nó
    ...
    {
      constValue = makeIntConstant(0); // Giá trị mặc định khi lỗi
    }
    break;
  case TK_CHAR:
    eat(TK_CHAR);
...
ConstantValue *compileConstant2(void)
{
  ...
  case TK_IDENT:
    eat(TK_IDENT);
    // Kiểm tra hằng số integer được khai báo và lấy giá trị
    obj = checkDeclaredConstant(currentToken->string);
...
Type *compileType(void)
{
  ...
  case TK_IDENT:
    eat(TK_IDENT);
    // Kiểm tra kiểu dữ liệu được khai báo và lấy kiểu thực tế
    ...
    {
      type = makeIntType(); // Kiểu mặc định khi lỗi
    }
    break;
  default:
...
void compileParam(void)
{
  ...
  eat(TK_IDENT);
  // Kiểm tra định danh tham số chưa được khai báo
  checkFreshIdent(currentToken->string);
...
void compileCallSt(void)
{
  eat(KW_CALL);
  eat(TK_IDENT);
  // Kiểm tra procedure được khai báo
